...
var bleManager = React.NativeModules.VPDScanner;
...
class VPDScanner {
  ...
  connect(peripheralId,name) {
    return new Promise((fulfill, reject) => {
      bleManager.connect(peripheralId,name, error => {
        if (error) {
          reject(error);
        } else {
          fulfill();
  ...
  createBond(peripheralId,name) {
    return new Promise((fulfill, reject) => {
      bleManager.createBond(peripheralId,name, error => {
        if (error) {
          reject(error);
        } else {
          fulfill();
  ...
  removeBond(peripheralId,name) {
    return new Promise((fulfill, reject) => {
      bleManager.removeBond(peripheralId,name, error => {
        if (error) {
          reject(error);
        } else {
          fulfill();
